  class SimpleSmtpMailer < Formula
	...
	def install
	  ...
	  ln_s bin/"simple-smtp-mailer", bin/"simple-smtp-mailer" if version == "1.2.0"
	...
	test do
	  ...
	  assert_match "simple-smtp-mailer version 1.0.0", shell_output("#{bin}/simple-smtp-mailer --version")
	end
  end
